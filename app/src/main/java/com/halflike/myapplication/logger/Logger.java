...
package com.halflike.myapplication.logger;
...
public class Logger {
     ...
     */
    public static String TAG = "HALFLIKE";
    /**
     ...
     * The log dir path
     */
    protected static String logDirPath = "/mnt/sdcard/halflike/log";
    /**
     * The log file base name
     */
    protected static String logFileBaseName = "halflike";
    /**
    ...
    public static void d(String msg) {
        if (isEnable) {
            android.util.Log.d(getTag(), buildMessage(TYPE.DEBUG, getTag(), msg, null));
        }
    }
     ...
     * The Tag is include class name and method name.
     */
    public static String getTag() {
    	...
    	tag.append(TAG + " ");
        tag.append(simpleClassName);
        tag.append(".");
        tag.append(caller.getMethodName());
        tag.append("()");
        return tag.toString();
    }
    ...
    public static void d(String msg, Throwable thr) {
        if (isEnable) {
            android.util.Log.d(getTag(), buildMessage(TYPE.DEBUG, getTag(), msg, thr), thr);
        }
    }
    ...
    public static void e(String msg) {
        if (isEnable) {
            android.util.Log.e(getTag(), buildMessage(TYPE.ERROR, getTag(), msg, null));
        }
    }
    ...
    public static void e(String msg, Throwable thr) {
        if (isEnable) {
            android.util.Log.e(getTag(), buildMessage(TYPE.ERROR, getTag(), msg, thr), thr);
        }
    }
    ...
    public static void i(String msg) {
        if (isEnable) {
            android.util.Log.i(getTag(), buildMessage(TYPE.INFO, getTag(), msg, null));
        }
    }
    ...
    public static void i(String msg, Throwable thr) {
        if (isEnable) {
            android.util.Log.i(getTag(), buildMessage(TYPE.INFO, getTag(), msg, thr), thr);
        }
    }
    ...
    public static void setPath(String logDirPath, String logFileBaseName, String logFileSuffix) {
        ...
        if (!TextUtils.isEmpty(logFileBaseName)) {
            Logger.logFileBaseName = logFileBaseName;
        }
...
//        FastDateFormat fdf = FastDateFormat.getInstance("yyyy-MM-dd-HH-mm-ss");
        String myDateString = time.format(myDate);
    ...
    public static void v(String msg) {
        if (isEnable) {
            android.util.Log.v(getTag(), buildMessage(TYPE.VERBOSE, getTag(), msg, null));
        }
    }
    ...
    public static void v(String msg, Throwable thr) {
        if (isEnable) {
            android.util.Log.v(getTag(), buildMessage(TYPE.VERBOSE, getTag(), msg, thr), thr);
        }
    }
    ...
    public static void w(Throwable thr) {
        if (isEnable) {
            android.util.Log.w(getTag(), buildMessage(TYPE.WARN, getTag(), "", thr), thr);
        }
    }
    ...
    public static void w(String msg) {
        if (isEnable) {
            android.util.Log.w(getTag(), buildMessage(TYPE.WARN, getTag(), msg, null));
        }
    }
    ...
    public static void w(String msg, Throwable thr) {
        if (isEnable) {
            android.util.Log.w(getTag(), buildMessage(TYPE.WARN, getTag(), msg, thr), thr);
        }
    }
